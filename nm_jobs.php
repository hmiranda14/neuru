...
if (!function_exists('nm_job_ensure')) {
    ...
    function nm_job_registry(): array {
        return [
            ...
            'cron_sentinel'    => ['Sentinel threat intel', 'healing', 0, 'every 3 min', 'SPECTRE threat-intel feed refresh (hourly) + NetFlow correlation → auto-block bad IPs via Collective Immunity.'],
