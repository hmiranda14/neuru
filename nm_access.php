...
if (!function_exists('nm_perm_catalog')) {
    function nm_perm_catalog(): array {
        return [
            ...
            ['switches',        'Switch Control Center','Monitoring',    'fa-solid fa-ethernet',               'switch_center.php'],
            ...
            ['sentinel',        'Sentinel Engine',    'Healing',        'fa-solid fa-shield-halved',          'sentinel.php'],
            ...
            ['utilities',       'NEURU Utilities',    'Device Tools',   'fa-solid fa-toolbox',                'utilities.php'],
