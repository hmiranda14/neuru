<?php
// NEURU — Shadow IT scan (NetFlow fingerprinting). Advisory only — never blocks
// automatically. */10 * * * * curl -s -H "X-NetMon-Token: <token>" http://localhost/cron_shadowit.php
$IS_CLI = (PHP_SAPI === 'cli');
require __DIR__ . '/connection.php';
require __DIR__ . '/nm_shadowit.php';
...
$r = nm_si_scan($conn);
echo $IS_CLI ? ("shadowit: ".json_encode($r)."\n") : json_encode(['ok'=>true]+$r+['at'=>date('c')]);
